...
<div class="actionDock" id="actionDock">
  <!-- Share Button -->
  <button class="dockButton" id="shareToggle" aria-label="Share this jotting" data-action="share">
...
<div class="sharePanel" id="sharePanel">
  ...
  <button class="shareItem" data-share="facebook" aria-label="Share on Facebook">
  ...
  <button class="shareItem" data-share="reddit" aria-label="Share on Reddit">
  ...
  <button class="shareItem" data-share="viber" aria-label="Share on Viber">
    <span class="tip">Viber</span>
