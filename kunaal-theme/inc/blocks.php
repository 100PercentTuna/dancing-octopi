 ...
 */
function kunaal_register_block_categories($categories): array {
    return array_merge(
        array(
            array(
 ...
 */
function kunaal_register_editor_scripts($blocks_dir, $blocks_uri, $version): void {
    $editor_deps = array(
        'wp-blocks',
        'wp-element',
        'wp-block-editor',
 ...
 * @param string $version Theme version
 */
function kunaal_register_view_scripts($blocks_dir, $blocks_uri, $version): void {
 ...
 */
function kunaal_add_reveal_class_processor($block_content): string|false {
 ...
 * @return string|false Updated HTML or false on failure
 */
function kunaal_add_reveal_class_dom($block_content): string|false {
 ...
 */
function kunaal_block_wrapper($block_content, $block): string {
